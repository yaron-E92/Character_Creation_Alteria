...
character = {'Name': 0, 'Race': '0', 'Soc': '0', 'Eco': '0'};

print("Choose Your name (maximum 24 characters)");
character['Name']=input(); #Getting the name from the user
print("The character's name is:", character['Name']); #TEST printing the name
...
print("The character's soc is:", character['Soc']); #TEST printing the characer's soc
if (character['Soc']=='N' or character['Soc']=='n'):
    character['Eco']='h'; #Giving Noble characters the "higher class" economical status
    print("Nobles are automatically rich (at least for now)");
elif (character['Soc']=='T' or character['Soc']=='t'):
    character['Eco'] = 'l'; #Giving Tribal characters the "lower class" economical status
...
print("The character's eco is:", character['Eco']);  # TEST printing the characer's eco
